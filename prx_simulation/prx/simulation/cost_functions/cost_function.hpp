...
namespace prx
{
    namespace sim
    {
        ...
        typedef boost::function<double (const trajectory_t&,const plan_t&)> true_cost_t;
        ...
        class cost_function_t
        {
          public:
            ...
            virtual double true_cost_function(const trajectory_t& t, const plan_t& p)
            {
