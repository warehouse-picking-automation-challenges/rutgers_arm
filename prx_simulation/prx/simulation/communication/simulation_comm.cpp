...
#include "prx_simulation/frame_count_msg.h"
    ...
    namespace sim
    {
        namespace comm
        {
            ...
            simulation_comm_t::simulation_comm_t()
            {
                ...
                frame_count_topic = node.advertise< prx_simulation::frame_count_msg >(node_name + "/frame_count", 5);
            ...
            void simulation_comm_t::publish_frame_number( unsigned frame )
            {
                prx_simulation::frame_count_msg msg;
                msg.frame = frame;
                
                frame_count_topic.publish( msg );
            }
