...
#include "prx_simulation/delegate_region_srv.h"
        ...
        namespace comm
        {
            ...
            class simulation_comm_t : public sim_base_communication_t
            {
              ...
              protected:
                ...
                /** @brief Topic which publishes the current frame count this simulation node is on */
                ros::Publisher frame_count_topic;
              ...
              public:
                ...
                void publish_frame_number( unsigned frame );
