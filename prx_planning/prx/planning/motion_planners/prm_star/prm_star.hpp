    ...
    namespace plan
    {
        ...
        class prm_star_t : public motion_planner_t
        {
          ...
          protected:
            ...
            bool pno_mode;
            /** @brief Whether or not to test connected components information for starts and goals */
            bool do_connection_test;

            util::hash_t< util::undirected_vertex_index_t, std::set< int > > adjacent_components;
            bool streaming_adjacency_test;
            virtual void add_adjacent_components( util::undirected_vertex_index_t vertex );
            virtual bool test_adjacent_connections( util::undirected_vertex_index_t vertex );
            ...
            /** @brief A flag telling us to recompute the weights on the edges of read-in roadmaps */
            bool update_weights_on_deserialize;
