    ...
    namespace plan
    {
        ...
        class prm_star_node_t : public util::undirected_node_t
        {
          ...
          public:
             ...
             * @param point_space The space where the space point lies. TODO : Do we really need this?
             */
            void deserialize(std::ifstream& input_stream, const util::space_t* point_space, std::string soft_constraint_type = "")
            {
                util::undirected_node_t::deserialize(input_stream, point_space, soft_constraint_type);
            }
        };
