...
#ifndef PRX_RRG_STAR_GRAPH_HPP
#define	PRX_RRG_STAR_GRAPH_HPP
...
namespace prx
{
    namespace plan
    {
         ...
         * @anchor rrg_node_t
         *
         * RRG nodes must remember the state space point they represent.  These nodes
         * additionally carry extra information for RRG and its variants.
         *
         * @brief <b> Node class used by the RRG planning structure. </b>
         *
         * @author Athanasios Krontiris
         */
        class rrg_node_t : public util::undirected_node_t
        {
          ...
          public:
             ...
             */
            void init_node(const util::space_t* space, const util::space_point_t* new_point, util::constraints_t* input_constraints = NULL)
            {
         ...
         * @anchor rrg_edge_t
         *
         * Edges in the RRG planning structure which must hold information such as weights,
         * controls used for generation, and an identifier.
         *
         * @brief <b> Edge class used in the RRG planning structure. </b>
         *
         * @author Athanasios Krontiris
         */
        class rrg_edge_t : public motion_planner_edge_t
        {
          public:
