    ...
    namespace plan
    {
        ...
        class planner_t
        {
          ...
          protected:
            ...
            /**
             * @brief Function to append a string to the statistics file in planners.
             *
             * All planners can use the same statistics file and write to it during a single execution
             * of prx_planning. The file is appended to by default.
             * NOTE: Currently opens and closes the file every time this is called.
             *
             * @param output_text The text data to be appended to the statistics file.
             */
            virtual void append_to_stat_file(std::string output_text);
          ...
          private:
            ...
            /** @brief Filehandle for printing to an output statistics file from all planners. */
            static std::ofstream planning_stat_file;

            /** @brief Filename of the output statistics file. The filename provided by the planner higher in the system tree is used. */
            static std::string stat_filename;
