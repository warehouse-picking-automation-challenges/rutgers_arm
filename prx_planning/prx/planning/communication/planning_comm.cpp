...
namespace prx
{
    ...
    namespace plan
    {
        ...
        namespace comm
        {
            ...
            {
                PRX_DEBUG_COLOR("Setting planning comm up with name: " << ros::this_node::getName(), PRX_TEXT_LIGHTGRAY);
            ...
            void planning_comm_t::request_space_information(const std::string& consumer_path, std::vector<interval_msg>& state_interval_msg, std::vector<interval_msg>& control_interval_msg)
            {
                ...
                // Construct request
                PRX_DEBUG_COLOR("Requesting space information for consumer:  " << consumer_path, PRX_TEXT_LIGHTGRAY);
