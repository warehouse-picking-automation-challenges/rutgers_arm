...
#ifndef PRX_BFS_TREE_PLANNER_HPP
#define PRX_BFS_TREE_PLANNER_HPP
...
namespace prx
{
    namespace plan
    {
        ...
        /**
         * @brief A simple bfs style tree search
         * @author Zakary Littlefield
         */
        class bfs_tree_planner_t : public motion_planner_t
        {

          public:
            bfs_tree_planner_t();
            virtual ~bfs_tree_planner_t();
          ...
          protected:
            ...
            std::queue<util::tree_vertex_index_t> vertex_queue;
