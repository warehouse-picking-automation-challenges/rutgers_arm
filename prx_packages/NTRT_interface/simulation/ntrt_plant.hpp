...
#ifndef PRX_NTRT_PLANT
#define PRX_NTRT_PLANT
...
namespace prx
{
    ...
    namespace sim
    {
         ...
         */
        class ntrt_plant_t : public plant_t
        {

          public:
            ntrt_plant_t();
            virtual ~ntrt_plant_t();
          ...
          protected:
            ...
            tgWorld* built_world;
            T6Model* myModel;
            // SuperBallModel* myModel;

            T6PIDController* pTC; 

            double motor_targets[12];

            util::config_t rotation;

            std::vector<tgKinematicActuator*> muscles;
            std::vector<tgBasicActuator*> passive;
            ...
            std::vector<std::pair<std::string,btRigidBody*> > rigid_bodies;
