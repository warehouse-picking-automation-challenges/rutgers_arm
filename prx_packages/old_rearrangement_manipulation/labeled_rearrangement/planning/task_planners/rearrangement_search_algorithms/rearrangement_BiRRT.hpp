/**
 * @file rearrangement_birrt_t.hpp
 *
...
#ifndef PRX_REARRANGEMENT_BIRRT_HPP
#define PRX_REARRANGEMENT_BIRRT_HPP
...
namespace prx
{
    ...
    namespace packages
    {
        namespace labeled_rearrangement_manipulation
        {
             ...
             */
            class rearrangement_birrt_t : public rearrangement_search_algorithm_t
            {

              public:
                rearrangement_birrt_t();
                virtual ~rearrangement_birrt_t();
              ...
              protected:
                ...
                util::undirected_vertex_index_t expand(std::vector<unsigned>& arrangement, util::distance_metric_t* metric, bool accept_partial_solutions = true);                                
                
                void update_stats(bool found_path);
               
                util::distance_metric_t* target_metric;
