...
// #include "planning/task_planners/cRS.hpp"
...
// PLUGINLIB_EXPORT_CLASS(prx::packages::labeled_rearrangement_manipulation::crs_t, prx::plan::planner_t)
...
//            const statistics_t* crs_t::get_statistics()
//            {
...
//            bool crs_t::connect_nodes(const crs_node_t* v, const crs_node_t* u)
//            {
//                if( statistics_clock.measure() > specs->time_limit )
//                {
//                    found_path = false;
...
//            bool crs_t::sample_arrangement(std::vector<unsigned>& arrangement)
//            {
//                arrangement_size = 0;
...
//            bool crs_t::valid_pose(const state_t* new_pose)
//            {
...
//            bool crs_t::node_exists(const std::vector<unsigned>& arrangement)
//            {
...
//            void crs_t::update_k(unsigned nr_nodes)
//            {
//                if( nr_nodes == 0 )
//                {
//                    k_near = 0;
