        ...
        namespace rearrangement_manipulation
        {
            ...
            class manipulator_query_t : public manipulation::manipulation_query_t
            {
              ...
              public:
                ...
                /**
                 * Restarts the query without cleaning the goals and the start points.
                 */
                ...
                std::vector<std::vector<unsigned> > constraints_in_order;
                std::vector<std::set<unsigned> > full_constraints;
                std::vector<double> solutions_costs;
                unsigned from_pose;
                unsigned to_pose;
                std::vector<int> reaching_points;
                std::vector<int> retracting_points;
                std::vector<sim::state_t*> goal_states;       
