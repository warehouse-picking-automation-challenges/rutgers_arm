        ...
        namespace rearrangement_manipulation
        {
            ...
            class rearrangement_manipulation_specification_t : public plan::specification_t
            {
              ...
              public:
                ...
                double z_on_table;
                /** @brief The orientation of the sampled poses.*/
                util::quaternion_t object_orientation;                                
                ...
                unsigned num_poses;
                /** @brief The number of extra poses that we would like to sample extra in the space to help the graph construction.*/
                unsigned num_extra_poses;
