    ...
    namespace packages
    {
        namespace rearrangement_manipulation
        {
            ...
            void rearrangement_manipulation_specification_t::init(const util::parameter_reader_t* reader, const util::parameter_reader_t* template_reader)
            {
                ...
                num_extra_poses = parameters::get_attribute_as<unsigned>("num_extra_poses", reader, template_reader, 0);
                ...
                boxes_env = parameters::get_attribute_as<bool>("boxes_env", reader, template_reader, false);
                ...
                if( parameters::has_attribute("object_orientation", reader, template_reader) )
                {
                    object_orientation = parameters::get_attribute_as<quaternion_t > ("object_orientation", reader, template_reader);
                }
                else
                {
                    object_orientation.set(0, 0, 0, 1);
                }
            }
