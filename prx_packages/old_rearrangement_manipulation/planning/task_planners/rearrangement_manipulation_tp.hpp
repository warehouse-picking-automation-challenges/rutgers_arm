        ...
        namespace rearrangement_manipulation
        {
            ...
            class rearrangement_manipulation_tp_t : public plan::task_planner_t
            {
              ...
              protected:
                 ...
                 */
                virtual void solve_path(const super_node_t& node, std::vector< unsigned >& start_arrangement, const std::vector< unsigned > goal_arrangement);
...
//                /** @brief An A* module that computes minimum conflict paths using tree search A* */
                ...
                virtual void compute_random_poses(unsigned size);
                ...
                virtual int similar_pose(sim::state_t* pose);
