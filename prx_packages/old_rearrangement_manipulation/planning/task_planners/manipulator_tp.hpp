        ...
        namespace rearrangement_manipulation
        {
            ...
            class manipulator_tp_t : public manipulation::manipulation_tp_t
            {
              ...
              public:
                ...
                /**
                 * @copydoc manipulation_tp_t::execute()
                 */
                virtual bool execute();
                
                /** @copydoc manipulation_tp_t::resolve_query()*/
              ...
              protected:
                ...
                /** @brief Helping variable when we want to move just the arm during the smoothing process.*/
                manipulator_mp_query_t* smoothing_query;      
                
                std::set<unsigned>* transit_constraints;

                virtual bool reach(manipulation::pose_t& pose, plan::query_t* query, int grasp_index = 0);
                virtual bool tranfer(manipulation::pose_t& start_pose, manipulation::pose_t& target_pose, plan::query_t* query, int start_grasp_index = 0, int target_grasp_index = 0);
