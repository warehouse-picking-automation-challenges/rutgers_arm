        ...
        namespace rearrangement_manipulation
        {
            ...
            class smoothing_info_t
            {
              ...
              public:
                ...
                sim::control_t* get_reaching_point();
                sim::control_t* get_retracting_point();
                void trim_plan_after_retracting_point();
                void trim_plan_before_reaching_point(const util::space_t* control_space);
