...
namespace prx
{
    namespace packages
    {
        namespace rearrangement_manipulation
        {
            ...
            void pebble_edge_t::get_connecting_points(unsigned& reaching, unsigned& retracting, unsigned source)
            {
                if( p_source == source )
                {
            ...
            void pebble_edge_t::get_connecting_points(unsigned& reaching, unsigned& retracting, util::undirected_vertex_index_t source)
            {
                if( source == v_source )
                    get_connecting_points(reaching, retracting, p_source);
                else
                {
                    get_connecting_points(reaching, retracting, p_target);
                }
            }
