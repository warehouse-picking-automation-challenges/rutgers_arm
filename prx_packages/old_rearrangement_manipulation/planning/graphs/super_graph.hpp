        ...
        namespace rearrangement_manipulation
        {
            ...
            class super_edge_t : public plan::motion_planner_edge_t
            {
              ...
              public:
                ...
                void get_plan(sim::plan_t& computed_plan, util::undirected_vertex_index_t source);
//                void get_plan(sim::plan_t& computed_plan, unsigned source_pose);
                virtual void get_connecting_points(unsigned& reaching, unsigned& retracting, util::undirected_vertex_index_t source);
//                virtual void get_connecting_points(unsigned& reaching, unsigned& retracting, unsigned source_pose);
