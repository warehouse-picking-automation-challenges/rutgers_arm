...
namespace prx
{
    ...
    namespace packages
    {
        namespace rearrangement_manipulation
        {
            ...
            void super_edge_t::get_plan(sim::plan_t& computed_plan, util::undirected_vertex_index_t source)
            {
                if( source == s_vertex )
                {
                    computed_plan += plan;
...
//            void super_edge_t::get_plan(sim::plan_t& computed_plan, unsigned source_pose)
//            {
//                if( source_pose == motion.first )
//                {
//                    get_plan(computed_plan, s_vertex);
//                }
//                else
//                {
//                    get_plan(computed_plan, NULL);
//                }
//            }

            void super_edge_t::get_connecting_points(unsigned& reaching, unsigned& retracting, util::undirected_vertex_index_t source)
            {
                if( source == s_vertex )
                {
                    reaching = reaching_point;
                    retracting = retracting_point;
                }
                else
                {
                    reaching = plan.size() - retracting_point - 1;
                    retracting = plan.size() - reaching_point - 1;
                }
            }

//            void super_edge_t::get_connecting_points(unsigned& reaching, unsigned& retracting, unsigned source_pose)
//            {
//                if( source_pose == motion.first )
//                {
//                    get_connecting_points(reaching, retracting, s_vertex);
//                }
//                else
//                {
//                    get_connecting_points(reaching, retracting, NULL);
//                }
//            }
        }
    }
