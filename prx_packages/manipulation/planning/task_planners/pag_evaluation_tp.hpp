...
// #ifndef PRX_POSE_AND_GRASP_EVALUATION_TP_HPP
// #define	PRX_POSE_AND_GRASP_EVALUATION_TP_HPP
...
//              */
//             class pag_evaluation_tp_t : public plan::task_planner_t
//             {

//               public:

//                 pag_evaluation_tp_t();
//                 virtual ~pag_evaluation_tp_t();
...
//                 std::vector<double> initial_rotation, rotation_axis, min_rotation_range, max_rotation_range;
//                 int nr_object_poses;
                
//                 bool random_rotation;
//                 bool save_left_arm, save_right_arm;
//                 bool evaluate_left_arm, evaluate_right_arm;
//                 std::vector< std::vector<double> > valid_left_poses, valid_right_poses;
