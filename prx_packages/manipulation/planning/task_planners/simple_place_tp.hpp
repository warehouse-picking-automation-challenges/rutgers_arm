...
#ifndef PRX_SIMPLE_PLACE_TP_HPP
#define	PRX_SIMPLE_PLACE_TP_HPP
...
namespace prx
{
    namespace packages
    {
        namespace manipulation
        {
             ...
             */
            class simple_place_tp_t : public plan::task_planner_t
            {

              public:

                simple_place_tp_t();
                virtual ~simple_place_tp_t();
