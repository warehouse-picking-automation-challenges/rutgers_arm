...
// #ifndef PRX_GRASP_RRT_TP_HPP
// #define	PRX_GRASP_RRT_TP_HPP
...
//              */
//             class grasp_rrt_tp_t : public plan::task_planner_t
//             {

//               public:

//                 grasp_rrt_tp_t();
//                 virtual ~grasp_rrt_tp_t();
...
//                 util::hash_t<std::string, std::string> connection_planner_names;;
...
//                 virtual bool compute_motion_plan(sim::plan_t& the_plan, util::constraints_t* the_constraints, sim::state_t* reached_goal, const std::vector<sim::state_t*>& object_states, sim::state_t* the_start, std::vector<grasp_t>& the_datas);
...
//                 virtual void get_neighborhood_connected_states(std::vector<sim::state_t*>& neighborhood_states, util::config_t workspace_point, int number_of_neighbors, sim::state_t* initial_state);
...
//                 prx::packages::apc::apc_sampler_t* neighborhood_sampler;
//                 double neighborhood;
