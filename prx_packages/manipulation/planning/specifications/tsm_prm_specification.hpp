...
#ifndef PRX_TSM_PRM_SPECIFICATION_HPP
#define PRX_TSM_PRM_SPECIFICATION_HPP
...
namespace prx
{
    ...
    namespace plan
    {
         ...
         */
        class tsm_prm_specification_t : public motion_planning_specification_t
        {

          public:
            tsm_prm_specification_t();
            virtual ~tsm_prm_specification_t();
