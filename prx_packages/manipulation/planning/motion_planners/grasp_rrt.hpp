...
// #ifndef PRX_GRASP_RRT_HPP
// #define PRX_GRASP_RRT_HPP
...
//                */
//               class grasp_rrt_t : public plan::motion_planner_t
//               {
...
//                          */
//                         plan::rrt_node_t* get_vertex(util::tree_vertex_index_t v) const;
...
//                          */
//                         plan::rrt_edge_t* get_edge(util::tree_edge_index_t e) const;
...
//                          *
//                          * @param jk_node The node being added. If the argument is not NULL, it is an output of JK steering and needs to use the JK plan for the edge
//                          *
//                          * @param jk_plan The plan being added on the edge to the added node. If the argument is not NULL, it is an output of JK steering
//                          * 
//                          * @return The index for the node in the boost::graph and whether it got added.
//                          */
//                          std::pair<bool, util::tree_vertex_index_t> add_node(util::space_point_t* n_state, sim::state_t* jk_node = NULL, sim::plan_t jk_plan = NULL);
...
//                          */
//                          util::tree_vertex_index_t retrace_path(sim::plan_t& plan, util::tree_vertex_index_t new_v, util::tree_vertex_index_t root_v);

//                          bool check_path_for_collisions_and_constraints(util::constraints_t* constraints, sim::trajectory_t& path_to_evaluate);

//                          util::tree_vertex_index_t add_to_tree(sim::state_t* point_to_add, bool start_node = false);
...
//                         std::vector<util::tree_vertex_index_t> start_vertices;
...
//                         /**
//                          * @brief Grasp RRT specification
//                          */
//                         plan::grasp_rrt_specification_t* grasp_rrt_specification;
                        
//                         sim::state_t* object_pose;
...
//                         /**
//                         * @brief End Effector SE3 space indices
//                         **/
//                         double _x, _y, _z, _qx, _qy, _qz, _qw;
//                         /**
//                         * @brief End Effector SE3 space
//                         **/
//                         util::space_t* end_effector_space;
//                         /**
//                         * @brief Flag to keep track of goal attainment. 
//                         **/
//                         bool reached_grasp_goal;
//                         /**
//                         * @brief Flag to allow restarts
//                         **/
//                         bool reset_starts;
//               };
