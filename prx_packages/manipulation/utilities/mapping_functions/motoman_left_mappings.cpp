...
PLUGINLIB_EXPORT_CLASS(prx::packages::manipulation::motoman_left_full_with_torso_state_mapping_t, prx::util::mapping_function_t)
PLUGINLIB_EXPORT_CLASS(prx::packages::manipulation::motoman_left_full_with_torso_control_mapping_t, prx::util::mapping_function_t)
...
PLUGINLIB_EXPORT_CLASS(prx::packages::manipulation::motoman_left_full_arm_state_mapping_t, prx::util::mapping_function_t)
PLUGINLIB_EXPORT_CLASS(prx::packages::manipulation::motoman_left_full_arm_control_mapping_t, prx::util::mapping_function_t)
