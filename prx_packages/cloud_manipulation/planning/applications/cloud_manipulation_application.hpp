// /**
//  * @file cloud_manipulation_application_t.hpp 
//  * 
...
//             /**
//              * @anchor cloud_manipulation_application_t
//              *
...
//              */
//             class cloud_manipulation_application_t : public plan::single_query_application_t
//             {

//               public:
//                 cloud_manipulation_application_t();
//                 virtual ~cloud_manipulation_application_t();
...
// //                int get_time_in_sec();
// //                void list_file();
//                 virtual void received_world_query_callback(const prx_simulation::world_config_msg& msg);
...
//                 ros::NodeHandle nh;
//                 ros::Publisher sent_plan_pub;
//                 ros::Subscriber changed_world_sub;
//                 bool waiting_for_simulation;
