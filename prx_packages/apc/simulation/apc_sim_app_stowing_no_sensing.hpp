 ...
 */
#ifndef PRX_APC_SIM_STOWING_NO_SENSING
#define PRX_APC_SIM_STOWING_NO_SENSING
...
namespace prx
{
    namespace packages
    {
        namespace apc
        {
            class apc_sim_app_stowing_no_sensing_t : public sim::application_t
            {
              public:
                apc_sim_app_stowing_no_sensing_t();
                virtual ~apc_sim_app_stowing_no_sensing_t();

                enum automaton_states
                {
                   START, SHELF_DETECTION, BIN_SELECTION, MOVE_AND_SENSE, POSE_ESTIMATION, GRASP_PLANNING, BLOCKING_ITEM_SELECTION, EXECUTE_REACHING, EVALUATE_GRASP,
                   ...
                   MOVE_TO_HOME, END, PLAN_BIN_TRAJECTORIES, PLAN_MOVE_TARGET_OUTSIDE_BIN, MOVE_INSIDE_BIN
                };
