 ...
 */
#ifndef PRX_APC_GENERATE_BIN_TRAJ
#define PRX_APC_GENERATE_BIN_TRAJ
...
namespace prx
{
    namespace packages
    {
        namespace apc
        {
            class apc_generate_bin_traj_t : public sim::application_t
            {
              public:
              	apc_generate_bin_traj_t();
              	virtual ~apc_generate_bin_traj_t();
              	...
              	enum automaton_states
	            {
	               ...
	               MOVE_TO_HOME, END, PLAN_BIN_TRAJECTORIES, PLAN_BIN_TRAJECTORIES_3_STAGES_FIRST, PLAN_BIN_TRAJECTORIES_3_STAGES_SECOND, PLAN_BIN_TRAJECTORIES_3_STAGES_THIRD
	            };
