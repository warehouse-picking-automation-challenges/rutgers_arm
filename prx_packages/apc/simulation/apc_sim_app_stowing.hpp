 ...
 */
#ifndef PRX_APC_SIM_STOWING
#define PRX_APC_SIM_STOWING
...
namespace prx
{
    namespace packages
    {
        namespace apc
        {
            class apc_sim_app_stowing_t : public sim::application_t
            {
              public:
                apc_sim_app_stowing_t();
                virtual ~apc_sim_app_stowing_t();
