/**
 * @file position_from_rigid_body_mapping.hpp 
 * 
...
#ifndef PRX_POSITION_FROM_RIGID_BODY_MAPPING_HPP
#define	PRX_POSITION_FROM_RIGID_BODY_MAPPING_HPP
...
{ 
    namespace packages 
    {
        ...
        {
            /**
             * @brief <b> Embeds an SE3 space into XYZ </b>
             * @author Zakary Littlefield
             */
            class position_from_rigid_body_mapping_t : public util::mapping_function_t
            {
            public:
                position_from_rigid_body_mapping_t() 
                {
                    domain = 13;
                    range = 3;
                    image_space = NULL;
                    ...
                    mapping_name = "position_from_rigid_body_mapping";
                }
                virtual ~position_from_rigid_body_mapping_t() {}    
