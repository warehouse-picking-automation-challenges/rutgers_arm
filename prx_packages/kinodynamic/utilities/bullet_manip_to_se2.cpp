...
#include "utilities/bullet_manip_to_se2.hpp"
#include <pluginlib/class_list_macros.h> 

PLUGINLIB_EXPORT_CLASS( prx::packages::mapping_functions::bullet_manip_to_se2_t, prx::util::mapping_function_t)
...
namespace prx
{
    ...
    {        
        ...
        {
            void bullet_manip_to_se2_t::embed() const
            {
                ...
                get_image_index(image_start_index + 3) = get_preimage_index(start_index + 15);
                // get_image_index(image_start_index + 4) = get_preimage_index(start_index + 28);
                ...
                get_image_index(image_start_index + 2) = v[2];
            }

            void bullet_manip_to_se2_t::invert() const
            {
                unsigned start_index = preimage_interval.first;
                unsigned image_start_index = image_interval.first;
                ...
                v[0] = v[1] = 0;
                v[2] = 1;
                q.set(v, get_image_index(image_start_index + 2));
