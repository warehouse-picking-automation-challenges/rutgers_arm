...
#ifndef PRX_BULLET_TO_XYTHETA_HPP
#define	PRX_BULLET_TO_XYTHETA_HPP
 ...
 */
class bullet_car_to_se2_t : public util::mapping_function_t
{
public:
    bullet_car_to_se2_t() 
    {
        ...
        output_space_name = "SE2andZ";
        mapping_name = "bullet_car_to_se2";
        v.resize(3);
    }
    virtual ~bullet_car_to_se2_t() {}    
