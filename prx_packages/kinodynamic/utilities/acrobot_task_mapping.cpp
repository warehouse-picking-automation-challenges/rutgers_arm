...
#include "utilities/acrobot_task_mapping.hpp"

#include <pluginlib/class_list_macros.h> 

PLUGINLIB_EXPORT_CLASS( prx::packages::mapping_functions::acrobot_task_mapping_t, prx::util::mapping_function_t)
...
namespace prx
{
    namespace packages
    {
        ...
        {
            void acrobot_task_mapping_t::embed() const
            {
            ...
            void acrobot_task_mapping_t::invert() const
            {
                unsigned start_index = preimage_interval.first;
                unsigned image_start_index = image_interval.first;
            ...
            void acrobot_task_mapping_t::init_spaces()
            {
