...
// PLUGINLIB_EXPORT_CLASS(prx::packages::rearrangement_manipulation::rearrangement_search_algorithm_t, prx::plan::planner_t)
...
//             void rearrangement_search_algorithm_t::create_spaces()
//             {
