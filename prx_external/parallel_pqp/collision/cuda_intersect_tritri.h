...
__device__ int triangleIntersection3(float3 const& P1, float3 const& P2, float3 const& P3,
	float3 const& Q1, float3 const& Q2, float3 const& Q3)
{
...
//	int next = (componentIdx + 1) % 3;
//	int next2 = (componentIdx + 2) % 3;

//	int sharedDataIdx = threadIdx.x;

	p[0] = make_float3(0, 0, 0);
	f3s_sub(p[1], P2, P1);
	f3s_sub(p[2], P3, P1);
	...
	{
		f3s_cross(n, e[0], e[1]);
		if(!project6(n, p[0], p[1], p[2], q[0], q[1], q[2])) break;
		f3s_cross(m, f[0], f[1]);
		if(!project6(m, p[0], p[1], p[2], q[0], q[1], q[2])) break;

		f3s_cross(t, e[0], f[componentIdx]);
		if(!project6(t, p[0], p[1], p[2], q[0], q[1], q[2])) break;
		f3s_cross(t, e[1], f[componentIdx]);
		if(!project6(t, p[0], p[1], p[2], q[0], q[1], q[2])) break;
		f3s_cross(t, e[2], f[componentIdx]);
		if(!project6(t, p[0], p[1], p[2], q[0], q[1], q[2])) break;

		f3s_cross(t, e[componentIdx], n);
		if(!project6(t, p[0], p[1], p[2], q[0], q[1], q[2])) break;

		f3s_cross(t, f[componentIdx], m);
		if(!project6(t, p[0], p[1], p[2], q[0], q[1], q[2])) break;
